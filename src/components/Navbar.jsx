    ...
    <>
      <Nav className="fixed-nav" activeKey="/home">
        ...
        <div className="nav-section options-section">
          ...
          <Nav.Item>
            <Nav.Link as={NavLink} to={"/category/combos"}>
              Combos
            </Nav.Link>
          </Nav.Item>
          <Nav.Item>
            <Nav.Link as={NavLink} to={"/category/aperitivos"}>
              Aperitivos
            </Nav.Link>
          </Nav.Item>
          <Nav.Item>
            <Nav.Link as={NavLink} to={"/category/tacos"}>
              Tacos
            </Nav.Link>
          </Nav.Item>
          <Nav.Item>
            <Nav.Link as={NavLink} to={"/category/burritos"}>
              Burritos
            </Nav.Link>
          </Nav.Item>
        </div>
